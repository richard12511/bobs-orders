...
/* package bobs-orders-0.1.0.0 */
#define VERSION_bobs_orders "0.1.0.0"
#define MIN_VERSION_bobs_orders(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "bobs-orders-0.1.0.0-CxSHM1dVxsFInTcPJViVdm"

#define CURRENT_PACKAGE_KEY "bobs-orders-0.1.0.0-CxSHM1dVxsFInTcPJViVdm"
